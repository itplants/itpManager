...
System.out.println("DUMMY_PLANTER");
		} else {
		//  プランターリストに登録
		for(int i=0;i<spn;i++){
			planterList.add(new PlanterClass("ITPLANTER-"+i));
System.out.println("ITPLANTER-"+i);
			}
		}
...
//	System.out.println("systemPlanterNo 2= "+systemPlanterNo);
		...
		getPlanterList().get(ITPlanterClass.getCurrentPlanterNo()).getInformation().setCameraName(0, oldCamName);
