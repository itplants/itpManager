...
public class itpCom extends Thread {
		/**	ポート番号	*/
		// 本番環境
		private static int port_no = 8080;
		private static String innerhostName = "cloud-garden.com";//

		//開発環境
		private static int dev_port_no = 8081;
		private static String dev_innerhostName = "listener.cloud-garden.com";//175.41.238.34
